// Build a project with Next.js 14, typeScript,Tailwindcss, and shadcn/ui
// npm install framer-motion,  npm install lucide-vue-next,  npx nypm add @kinde-oss/kinde-auth-nextjs, npm i react-dropzone
// ----------------------------------------------------------------------------------------------------
...
import { ArrowRight, Check, Smile, Star } from "lucide-react";
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              <Image
                ...
                alt="Phone case with custom design"
                width={200}
                height={200}
              ...
              <Image
                ...
                className="absolute w-20 -left-6 bottom-24 select-none"
              />
              <Phone className="w-64" imageSrc="/testimonials/3.jpg" />
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-10">
              <Image
                src="/arrow.png"
                alt="user image"
                width={100}
                height={100}
                className="  absolute top-[25rem] md:top-1/2 -translate-1/2 z-10 left-1/2 -translate-x-1/2 rotate-90 md:rotate-0 "
              />
              {/*  */}
              <Image
                src="/phone2.jpg"
              ...
              {/* <Phone className="w-100" imageSrc="/horse_phone.jpg" /> */}
            </div>
          </div>

          <div>
            <div>
              <ul className="mx-auto mt-12 sm:text-lg space-y-2 w-fit">
                <li className="w-fit">
